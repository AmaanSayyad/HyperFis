        ...
        <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
          <div className="px-6 pb-24 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-48 xl:col-span-6">
            <div className="mx-auto max-w-2xl lg:mx-0">
              ...
              <h1 className="mt-24 text-2xl tracking-tight text-gray-900 sm:mt-1 sm:text-5xl">
             Yield Farming <br/> Automated Strategies <br /> Defi on the go
              </h1>
              ...
              <div className="mt-10 flex flex-col gap-y-4">
                ...
                <div className="font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 w-20">
                  ...
                  >
                    ...
                    <Link  href="https://anonaadhaarverification.vercel.app/" >
          ...
          <div className="relative lg:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0">
            <img
              className="w-full h-1/2 bg-gray-50 object-cover lg:absolute lg:inset-0 lg:aspect-auto lg:h-full"
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 mt-20">
        ...
        <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
          <img
            ...
            src="https://logowik.com/content/uploads/images/the-graph8315.jpg"
            alt="Transistor"
            width={158}
            height={48}
          />
          ...
          <img
            ...
            src="https://pbs.twimg.com/profile_images/1729295494269079552/IVt8A2Xh_400x400.png"
            alt="SavvyCal"
            width={158}
            height={48}
          />
          <img
            ...
            src="https://explorer.testnet.lumio.io/static/og_placeholder.png"
            alt="Statamic"
            width={158}
            height={48}
          />
